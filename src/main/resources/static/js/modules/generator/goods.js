$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'generator/gpa/goods/list',
        datatype: "json",
        colModel: [			
...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.goods.goodsId == null ? "generator/gpa/goods/save" : "generator/gpa/goods/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		del: function (event) {
			...
			confirm('确定要删除选中的记录？', function(){
				$.ajax({
					type: "POST",
				    url: baseURL + "generator/gpa/goods/delete",
                    contentType: "application/json",
		...
		getInfo: function(goodsId){
			$.get(baseURL + "generator/gpa/goods/info/"+goodsId, function(r){
                vm.goods = r.goods;
            });
		},
